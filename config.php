...
$strategy = isset($_POST['value']) ? $_POST['value'] : '';
$digital = isset($_POST['value']) ? $_POST['value'] : '';
$creative_design = isset($_POST['value']) ? $_POST['value'] : '';
$webDevelopment = isset($_POST['value']) ? $_POST['value'] : '';
...
$site = isset($_POST['value']) ? $_POST['value'] : '';
	...
	$strategy = (preg_match("/strategy.php/", $_SERVER['SCRIPT_FILENAME']));
	$digital = (preg_match("/digital.php/", $_SERVER['SCRIPT_FILENAME']));
	$creative_design = (preg_match("/creative_design.php/", $_SERVER['SCRIPT_FILENAME']));
	$webDevelopment = (preg_match("/webdevelopment.php/", $_SERVER['SCRIPT_FILENAME']));
