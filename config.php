...
$strategy_consulting = isset($_POST['value']) ? $_POST['value'] : '';
$digital_marketing = isset($_POST['value']) ? $_POST['value'] : '';
$creative_design = isset($_POST['value']) ? $_POST['value'] : '';
$web_mobile_development = isset($_POST['value']) ? $_POST['value'] : '';
...
$site = isset($_POST['value']) ? $_POST['value'] : '';
	...
	$strategy_consulting = (preg_match("/strategy_consulting.php/", $_SERVER['SCRIPT_FILENAME']));
	$digital_marketing = (preg_match("/digital_marketing.php/", $_SERVER['SCRIPT_FILENAME']));
	$creative_design = (preg_match("/creative_design.php/", $_SERVER['SCRIPT_FILENAME']));
	$web_mobile_development = (preg_match("/web_mobile_development.php/", $_SERVER['SCRIPT_FILENAME']));
