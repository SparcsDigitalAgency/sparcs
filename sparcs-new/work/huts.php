      ...
      <div class="row">
         ...
         <div class="col-lg-6 paddingsidestop80">
            <div class="portfolio-section-textholder">
               <img src="<?php echo $path; ?>img/huts/huts-logo.png" alt="" class="img-responsive wow fadeInLeft">
               <h2 class=" wow fadeInRight">Huts Resturant</h2>
...
<!--==========================
   portfolio  Section4
   ============================-->
<section id="huts-portfolio-section4">
   <div class="container">
      <div class="row">
         <div class="col-lg-6">
            <div class="text-holder wow fadeInLeft padding-top20">
